"""Minimal subset of the Pydantic API required for the tests."""
...
class BaseModel:
    ...
    def __init__(self, **data: Any) -> None:
        ...
        # Store any extra keys for parity with permissive Pydantic behaviour.
    ...
    def model_dump(self, *args: Any, **kwargs: Any) -> Dict[str, Any]:
        """Alias for :meth:`dict` for convenience."""

        return self.dict(*args, **kwargs)

    @classmethod
    def parse_obj(cls, obj: Any) -> "BaseModel":
        """Instantiate the model from a mapping or compatible object."""
